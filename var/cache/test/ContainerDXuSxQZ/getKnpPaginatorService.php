...
class getKnpPaginatorService extends App_KernelTestDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['knp_paginator'] = $container->createProxy('PaginatorProxy2f9629f', static fn () => \PaginatorProxy2f9629f::createLazyProxy(static fn () => self::do($container, false)));
        }
