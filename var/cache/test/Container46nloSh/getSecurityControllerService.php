...
class getSecurityControllerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.F0MYvAX'] ?? $container->load('get_ServiceLocator_F0MYvAXService'))->withContext('App\\Controller\\SecurityController', $container));
