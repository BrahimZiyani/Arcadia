...
class __TwigTemplate_c9054ae8ced092ef19bea86c5c671ba5 extends Template
{
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["animal"]) {
            ...
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["animal"], "images", [], "any", false, false, false, 54)) > 0)) {
                // line 55
                yield "                            <img src=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/animals/" . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["animal"], "images", [], "any", false, false, false, 55), 0, [], "array", false, false, false, 55))), "html", null, true);
                yield "\" alt=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["animal"], "nom", [], "any", false, false, false, 55), "html", null, true);
            ...
            yield "                        
                        <p>Race : ";
            // line 60
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["animal"], "race", [], "any", false, false, false, 60), "html", null, true);
            yield "</p>
                        <p>État de santé : ";
            // line 61
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["animal"], "etatDeSante", [], "any", false, false, false, 61), "html", null, true);
            yield "</p>
                    </div>
                </div>
            </div>
...
";
    ...
    {
        return array (  235 => 68,  228 => 66,  218 => 61,  214 => 60,  211 => 59,  207 => 57,  199 => 55,  197 => 54,  192 => 52,  187 => 49,  182 => 48,  173 => 41,  166 => 39,  155 => 35,  151 => 33,  146 => 32,  134 => 23,  129 => 21,  124 => 18,  117 => 13,  109 => 11,  107 => 10,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
