...
class __TwigTemplate_51c139699d1a33b59d2fb6160a2c9c19 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "page/services/services_new.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "page/services/services_new.html.twig"));
    ...
    <div class=\"card shadow-lg border-0 p-4\">
        ...
        yield "
                ";
        // line 17
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "description", [], "any", false, false, false, 17), 'widget', ["attr" => ["class" => "form-control", "rows" => "3", "placeholder" => "Description du service"]]);
        yield "
            </div>
            <div class=\"form-group\">
                ";
        // line 20
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 20, $this->source); })()), "images", [], "any", false, false, false, 20), 'label');
        yield "
                ";
        // line 21
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "images", [], "any", false, false, false, 21), 'widget', ["attr" => ["class" => "form-control-file"]]);
        yield "
...
";
    ...
    {
        return array (  144 => 27,  135 => 21,  131 => 20,  125 => 17,  121 => 16,  115 => 13,  111 => 12,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Ajouter un Nouveau Service{% endblock %}
...
<div class=\"container mt-5\">
    ...
    <div class=\"card shadow-lg border-0 p-4\">
        {{ form_start(form, { 'attr': { 'enctype': 'multipart/form-data' } }) }}
            <div class=\"form-group\">
                {{ form_label(form.nom) }}
                {{ form_widget(form.nom, {'attr': {'class': 'form-control', 'placeholder': 'Nom du service'}}) }}
            </div>
            <div class=\"form-group\">
                {{ form_label(form.description) }}
                {{ form_widget(form.description, {'attr': {'class': 'form-control', 'rows': '3', 'placeholder': 'Description du service'}}) }}
            </div>
            <div class=\"form-group\">
                {{ form_label(form.images) }}
                {{ form_widget(form.images, {'attr': {'class': 'form-control-file'}}) }}
                <small class=\"form-text text-muted\">Vous pouvez ajouter plusieurs images (JPEG, PNG, GIF).</small>
            </div>
            <div class=\"text-center mt-4\">
                <button type=\"submit\" class=\"btn btn-primary\">Ajouter</button>
...
{% endblock %}
", "page/services/services_new.html.twig", "C:\\xampp\\htdocs\\Arcadia\\templates\\page\\services\\services_new.html.twig");
    }
}
